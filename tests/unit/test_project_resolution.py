...
def state_with_activities():
    ...
    return {
        ...
        "email_data": {"sender": "test@test.com", "subject": "Test", "body_text": "", "billing_month": "2025-10"},
...
async def test_resolve_projects_with_react_agent(state_with_activities, mock_boond_projects):
    ...
    with patch("src.nodes.project_resolution.BoondManagerClient") as MockClient:
        ...
        print("="*80)
        print("\nInput project name:", state_with_activities["consultant_activities"][0]["project_name"])
        print("\nResolved activity:")
        ...
        assert result["current_step"] == "reconciliation"

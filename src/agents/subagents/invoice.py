...
class ToInvoiceSubagent(BaseModel):
    """Transfers work to the Invoice Agent responsible for reading and creating invoices.
    ...
    request: str = Field(
        description="Optimized uery with specific invoice operation and required parameters."
    )


invoice_agent = ReactAgent(
    model=get_llm(),

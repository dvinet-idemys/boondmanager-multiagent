...
timesheet_subagent = Subagent(
    name="timesheet",
    full_name="Timesheet Subagent",
    description="",
    node=AssistantNode(get_llm(), TIMESHEET_AGENT_PROMPT, tools, truncate_msgs=True),
    tools=tools,
    to_subagent_fn=ToTimesheetSubagent,
    truncate_state=True,
)
